# I will be executed at the AWS Workspaces (Notebook) TERMINAL by: >>python etl.py
print("I'm the file [etl.py]...") 

# import configparser # At AWS not required *AWS!
...
# *AWS # config = configparser.ConfigParser()
# *AWS # config.read('dl.cfg')
# *AWS # print('>> Read Out Config-Infos from [dl.cfg]')

# *AWS # os.environ['AWS_ACCESS_KEY_ID']     = config['AWS']['AWS_ACCESS_KEY_ID']
# *AWS # os.environ['AWS_SECRET_ACCESS_KEY'] = config['AWS']['AWS_SECRET_ACCESS_KEY']
...
def process_song_data(spark, input_data, output_data):
    ...
    # Experiment/ time saving with a SUBSET of the files:
...
def process_log_data(spark, input_data, output_data):
    ...
    # Experiment/ time saving with a SUBSET of the data: 
